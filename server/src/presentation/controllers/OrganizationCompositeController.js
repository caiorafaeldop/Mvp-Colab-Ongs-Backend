...
class OrganizationCompositeController {
  ...
  async addChildOrganization(req, res) {
    try {
      ...
      const result = await this.organizationCompositeService.addChildOrganization(parentId, childId);
  ...
  async removeChildOrganization(req, res) {
    try {
      ...
      const result = await this.organizationCompositeService.removeChildOrganization(parentId, childId);
  ...
  async findOrganizationInTree(req, res) {
    try {
      ...
      const result = await this.organizationCompositeService.findOrganizationInTree(treeRootId, targetId);
