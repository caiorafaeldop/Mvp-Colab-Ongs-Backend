...
class AuthenticationTemplate extends BaseTemplate {
  ...
  getAuthenticationType() {
    throw new Error(`Method getAuthenticationType() must be implemented by ${this.constructor.name}`);
  }
  ...
  async performAuthentication() {
    throw new Error(`Method performAuthentication() must be implemented by ${this.constructor.name}`);
  }
