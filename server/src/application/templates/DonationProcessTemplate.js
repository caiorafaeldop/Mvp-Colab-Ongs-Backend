...
class DonationProcessTemplate extends BaseTemplate {
  ...
  async validateDonationSpecifics() {
    throw new Error(
      `Method validateDonationSpecifics() must be implemented by ${this.constructor.name}`
    );
  }
  ...
  async prepareDonationSpecifics(donationData) {
    throw new Error(
      `Method prepareDonationSpecifics() must be implemented by ${this.constructor.name}`
    );
  }
