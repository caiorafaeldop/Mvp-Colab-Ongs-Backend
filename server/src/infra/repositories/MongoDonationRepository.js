...
class MongoDonationRepository {
  ...
  async findByOrganizationId(organizationId) {
    try {
      ...
      console.error('[MONGO DONATION REPOSITORY] Erro ao buscar doações da organização:', error.message);
      throw error;
    }
  }
  ...
  async existsByMercadoPagoId(mercadoPagoId) {
    try {
      ...
      console.error('[MONGO DONATION REPOSITORY] Erro ao verificar existência por MP ID:', error.message);
      return false;
    }
  }
  ...
  async findBySubscriptionId(subscriptionId) {
    try {
      ...
      console.error('[MONGO DONATION REPOSITORY] Erro ao buscar doação por subscription ID:', error.message);
      throw error;
    }
  }
  ...
  async existsBySubscriptionId(subscriptionId) {
    try {
      ...
      console.error('[MONGO DONATION REPOSITORY] Erro ao verificar existência por subscription ID:', error.message);
      return false;
    }
  }
}
